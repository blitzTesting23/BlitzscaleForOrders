...
describe('Status Change APIs', function () {
  const awbForPreProd = "14228557069293"
  const timestampForNDRonPreProd = "2024-02-02T08:40:14Z"
  const awbForStage = "DUMRXFDE8DRK"
  const failedDeliveryDate="2024-02-02T18:03:42.767"
  const timeStampForNDRonStage = "2024-01-20T22:00:00.000Z"
  const nslCodeForFailedDelivery="CL-108"
  const DeliverydateForStage="2024-02-03T19:08:42.767"
//EOD-74 ST-102 EOD-151 EOD-69  EOD-86  EOD-6O EOD-121 CL-108 EOD-43 EOD-105
  // doc for status change APIs   https://docs.google.com/document/d/1ZAIFjDZPsANgWa3FY_s8B1JTO6FhSl98AUz9JjBakNQ/edit
    ...
    const PayloadDelivered=
      {
        Shipment: {
            Status: {
                Status: "delivered",
                StatusDateTime: DeliverydateForStage,
                StatusType: "DL",
...
cy.wait(2000)
  ...
  it('FailedDelivery', function () {
    const payloadFour = {
      Shipment: {
        Status: {
          Status: "pending",
          StatusDateTime:failedDeliveryDate,
          StatusType: "UD",
          StatusLocation: "Gujarat",
          Instructions: "Failed Delivery"
        },
        PickUpDate: "",
        NSLCode:nslCodeForFailedDelivery,
        Sortcode: "IXC",
        ReferenceNo: "NCR1700646462703-2V",
        AWB: awbForStage
      }
  ...
  it.only('DispatchedForPreProd ', function () {
  ...
  it.only('OutForDeliveryForPreProd', function () {
